...
{
    public partial class darkUpdating : Form
    {
        ...
        public void UpdateStatus()
        {
            ...
            newStatus.Parameters.AddWithValue("@id", darkList.Vars.statusId);
        ...
        public string ReporterUsername()
        {
            ...
            reportId.Parameters.AddWithValue("@id", darkList.Vars.statusId);
        ...
        public void GetStatus()
        {
            ...
            getStatus.Parameters.AddWithValue("@id", darkList.Vars.statusId);
        ...
        private void darkUpdating_Load(object sender, EventArgs e)
        {
            statusBox.Items.Add("In Progress");
            statusBox.Items.Add("Finished");
            statusBox.Items.Add("Escalated");
            GetStatus();
            label4.Text = Convert.ToString(darkList.Vars.statusId);
        }
    }
}
